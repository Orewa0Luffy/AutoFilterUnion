...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://iili.io/38mMga9.md.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '8864877012@mbk')

#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '').split()]
TEXT = environ.get("APPROVED_WELCOME_TEXT", "<b>{mention},\n\nʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ {title} ɪs ᴀᴘᴘʀᴏᴠᴇᴅ.\n\‣ ᴘᴏᴡᴇʀᴇᴅ ʙʏ @Union_Botss</b>")
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/Union_Tutorial')  # How to open tutorial link for verification
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Weebs_Union')  # Support group link (make sure bot is admin)
